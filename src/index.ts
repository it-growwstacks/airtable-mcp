...
interface Env {
  ...
  AIRTABLE_TABLE_PERMISSIONS: string;
...
export class MCPContainer extends Container {
  ...
  envVars = {
    ...
    AIRTABLE_TABLE_CLIENTS: env.AIRTABLE_TABLE_CLIENTS,
    AIRTABLE_TABLE_PROJECTS: env.AIRTABLE_TABLE_PROJECTS,
    AIRTABLE_TABLE_TASKS: env.AIRTABLE_TABLE_TASKS,
    AIRTABLE_TABLE_PERMISSIONS: env.AIRTABLE_TABLE_PERMISSIONS,
